...
export function Header() {
  ...
  return (
    <div className="shadow-md w-full fixed top-0 left-0 z-10">
      <div className="md:flex items-center justify-between bg-white dark:bg-gray-700 py-4 md:px-10 px-7">
        <div
      ...
      text-gray-800"
        ...
        <ul
          className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-white dark:bg-gray-700 md:z-auto 
          ...
          {Links.map((link) => (
            <li key={link.name} className="md:ml-8 text-xl md:my-0 my-7">
              <a
                href={link.link}
                onClick={handleOpenMenu}
                className="font-bold text-2xl dark:text-gray-100 dark:hover:text-gray-200
...
// <nav
//       className="bg-zinc-100 dark:bg-gray-700 shadow-md w-full p-6
...
//         </figure>
//       </div>
//       <ul className="md:flex md:items-center z-[-1] md:z-auto gap-6 md:static absolute">
//         <li>
//           <a
//             href=""
//             className="font-bold text-2xl dark:text-gray-100 dark:hover:text-gray-200
//             hover:underline hover:underline-offset-8 my-5 md:my-0"
//           >
//             Home
//           </a>
//         </li>
...
//         </li>
//         <li>
//           <button className="dark:bg-orange-500 dark:hover:bg-orange-400 transition-colors p-2 rounded-full">
...
// <div className="flex w-full bg-zinc-100 shadow-md dark:bg-gray-700 h-20">
// <div className="flex flex-1 items-center justify-between mx-auto px-6 max-w-screen-lg">
//   <figure>
//     <svg
//       width="42"
//       height="40"
